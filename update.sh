...
# if [ ! -f $public_file ];then
	# wget -O $public_file https://www.sxsay.com/bt/public.sh -T 5;
# fi
# . $public_file

download_Url='https://www.sxsay.com'
setup_path=/www
version=''
...
wget -T 5 -O panel.zip https://www.sxsay.com/bt//LinuxPanel-5.9.1_pro.zip
if [ ! -f "panel.zip" ];then
...
if [ "${check_bt}" = "" ];then
	rm -f /etc/init.d/bt
	wget -O /etc/init.d/bt https://www.sxsay.com/bt/install/src/bt.init -T 10
